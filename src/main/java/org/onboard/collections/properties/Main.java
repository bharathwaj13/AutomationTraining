...
/**
 *
 * In this task, you will describe a class that can operate several properties files. One of them is the main properties file, and the others are the sets of the default properties. The main properties file is named config.propertiesIn addition to a set of properties, this file may contain the property default.filenames, which defines the names of files with default properties.
 * For example,
 * default.filenames = default1,default2,default3,... where default1, default2, default3, ...are the names of properties files (without extension .properties).
